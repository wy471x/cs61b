...
public class PercolationOther {
    ...
    public static void main(String[] args) {
        PercolationOther percolation = new PercolationOther(1);
        Assert.assertFalse(percolation.percolates());
        percolation.open(0, 0);
        Assert.assertTrue(percolation.percolates());

        PercolationOther percolation2 = new PercolationOther(5);
        ...
        PercolationOther percolation3 = new PercolationOther(3);
