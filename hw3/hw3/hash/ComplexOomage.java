...
public class ComplexOomage implements Oomage {
     ...
     * Hight bound.
     */
    private static final int HIGHT = 255;
    ...
    /**
     * Constructor for ComplexOomage class.
     *
     * @param params
     */
    ...
    /**
     * Checking validation for params.
     *
     * @param param
     */
    private void validate(Integer param) {
        if (param == null || param < LOW || param > HIGHT) {
    ...
    /**
     * Generate random ComplexOomage object.
     *
     * @return
     */
